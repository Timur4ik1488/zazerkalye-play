...
namespace Zazerkalye.Enemies
{
    public class Enemy : MonoBehaviour
    {
        ...
        void BuildBobyl(Color color, float scale)
        {
            ...
            col.center = new Vector3(0f, 0.55f * scale, 0f);
            col.radius = 0.55f * scale;
            col.isTrigger = true;
        }
        ...
        void Update()
        {
            ...
            if (_hitFlash > 0f) { _hitFlash -= Time.deltaTime; Tint(Color.white); }
